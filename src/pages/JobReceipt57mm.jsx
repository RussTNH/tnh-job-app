...
export default function JobReceipt57mm() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 px-4 py-6 text-white">
      <div className="mx-auto mb-4 flex max-w-md flex-wrap gap-3">
        <button
          type="button"
          onClick={() => navigate(-1)}
      ...
      <div className="mx-auto max-w-md">
        <div className="mb-4 rounded-2xl border border-neutral-800 bg-neutral-900 p-4 shadow-xl">
          <h1 className="text-lg font-semibold text-white">57mm Job Receipt</h1>
          <p className="mt-1 text-sm text-neutral-400">
            This page is for POS thermal printing only and uses the monochrome printer logo.
          </p>
        </div>

        <div className="mx-auto w-[57mm] max-w-[57mm] rounded-2xl border border-neutral-800 bg-white p-3 text-black shadow-2xl">
        ...
        <div className="mt-4 rounded-2xl border border-neutral-800 bg-neutral-900 p-4 shadow-xl">
